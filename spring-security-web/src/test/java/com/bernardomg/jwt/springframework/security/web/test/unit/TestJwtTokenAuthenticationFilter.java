...
package com.bernardomg.jwt.springframework.security.web.test.unit;
...
import com.bernardomg.jwt.springframework.security.web.JwtTokenAuthenticationFilter;
import com.bernardomg.jwt.springframework.security.web.test.config.factory.Tokens;
import com.bernardomg.jwt.springframework.security.web.test.config.factory.UserDetailsConstants;
import com.bernardomg.jwt.springframework.security.web.test.config.factory.UserDets;
...
@DisplayName("JwtTokenAuthenticationFilter")
class TestJwtTokenAuthenticationFilter {
    ...
    public TestJwtTokenAuthenticationFilter() {
        super();
    }
    ...
    void testDoFilter() throws ServletException, IOException {
        ...
        userDetails = UserDets.enabled();
        given(userDetailsService.loadUserByUsername(UserDetailsConstants.USERNAME)).willReturn(userDetails);

        jwtTokenData = new JwtTokenData(null, UserDetailsConstants.USERNAME, null, null, null, null, null, null);
        ...
        Assertions.assertThat(authentication.getName())
            .isEqualTo(UserDetailsConstants.USERNAME);
    }
    ...
    void testDoFilter_CredentialsExpired() throws ServletException, IOException {
        ...
        userDetails = UserDets.credentialsExpired();
        given(userDetailsService.loadUserByUsername(UserDetailsConstants.USERNAME)).willReturn(userDetails);
